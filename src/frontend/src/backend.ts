...
export class Backend implements backendInterface {
    ...
    async addFrame(arg0: T): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addFrame(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createInvoice(arg0: T__1): Promise<T__1> {
        if (this.processError) {
            try {
    ...
    async deleteFrame(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteFrame(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllFrames(): Promise<Array<T>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllFrames();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllInvoices(): Promise<Array<T__1>> {
        if (this.processError) {
            try {
    ...
    async getDailySales(arg0: string): Promise<{
        totalProfit: number;
        totalSales: number;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailySales(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFrame(arg0: string): Promise<T> {
        if (this.processError) {
            try {
                const result = await this.actor.getFrame(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getInvoice(arg0: string): Promise<T__1> {
        if (this.processError) {
            try {
    ...
    async getMonthlySales(arg0: bigint, arg1: bigint): Promise<{
        totalProfit: number;
        totalSales: number;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.getMonthlySales(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateFrame(arg0: string, arg1: T): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateFrame(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
